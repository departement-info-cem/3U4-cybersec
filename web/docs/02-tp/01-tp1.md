...
# TP1 : Analyse d'un événement de cybersécurité (réel ou fictif — culture populaire)
...
En 4–5 phrases/ligne, présentez succinctement ce qui s'est passé.

## Vulnérabilité / exploit / correctif
 
## Confidentialité, intégrité ou disponibilité et CVSS 3.1

Calcul des composantes du CVSS 3.1 et du score.

Si cela s'applique, vous formulez l'événement sous la forme d'une vulnérabilité, d'un exploit et, éventuellement, du correctif.
Si cela ne s'applique pas, expliquez pourquoi.

```

## Barème

Deux éléments sont notés : le rapport remis sur GitHub et la présentation en classe.
...
- **1 point** : le français est correct (utiliser au minimum le correcteur de Word).
